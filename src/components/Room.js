/**
 * Created by matthew.jones on 02/11/2016.
 */
...
class App extends React.Component {
    constructor() {
        ...
        componentWillMount() {
            this.ref = base.syncState(`${this.props.params.roomId}/users`, {
                context: this,
                state: 'users',
            });
        ...
        removeFish(key, fish) {
            ...
            //delete fishes[key];
            //instead we need to set it to null
            fishes[key] = null;
            this.setState({
                fishes: fishes,
            });
        ...
        render () {
            return (
                <div className="catch-of-the-day">
                    ...
                    <Inventory addFish={this.addFish} storeId={this.props.params.storeId} updateFish={this.updateFish} removeFish={this.removeFish} loadSamples={this.loadSamples} fishes={this.state.fishes} />
                </div>
            );
        }
    }
